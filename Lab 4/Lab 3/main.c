...
//  Date: Oct. 21, 2022
//  Lab Section: L1S
//  Program Description: Print a picture using triangles of the specified size and character on the screen. The picture should consists of a series triangle each with height 1 smaller than the previous until height is 1.
//
